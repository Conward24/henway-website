...
(function () {
  ...
  function mount() {
    ...
    wrap.innerHTML =
      ...
      '<p class="sub">The thing you keep working around is an app you haven’t built yet. About seven minutes from a plain-words description to a working app at its own link. Join the list and you get the door first. 25 Founding Hen seats open Sep 12.</p>' +
      '<form class="wl">' +
