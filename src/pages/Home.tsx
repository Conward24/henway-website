...
export default function Home() {
  ...
  /** Case studies strip: auto-scroll + manual horizontal scroll */
  ...
  /** Resume autoplay immediately after user un-pauses; otherwise pointer/touch cooldown blocks scrolling. */
  useEffect(() => {
    if (!isPaused) {
