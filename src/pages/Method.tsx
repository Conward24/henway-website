...
const moves = [
  ...
  { n: '4', title: 'Get your prompt', desc: 'Nothing new to write. It assembles from your four answers, matched to the right build tool, with a one-page brief and compliance flags where they apply.' },
];
    ...
    <main className="pt-20">
      ...
      <section className="section-container text-center max-w-4xl">
        ...
        <p className="text-xl md:text-2xl text-henway-charcoal/80 max-w-2xl mx-auto mb-4">
          ...
          Here is the four-move method that turns what you already know into a build-ready prompt.
        </p>
      ...
      <section className="bg-henway-charcoal text-white py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-white text-3xl md:text-5xl mb-8 leading-tight">Person → Translation → Perfect prompt → Build tool.</h2>
      ...
      <section className="section-container">
        ...
        <p className="text-center text-lg font-medium text-henway-charcoal/70 max-w-2xl mx-auto mt-12">
          The punchline: you never had to figure out a prompt. You described your world four times and the prompt fell out.
        </p>
      </section>
      ...
      <section className="bg-henway-offwhite">
        <div className="section-container max-w-4xl">
          <div className="text-center mb-10">
            ...
            <h2>From "records are a mess" to a build prompt.</h2>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-2xl overflow-hidden border border-henway-border shadow-2xl bg-white max-w-2xl mx-auto">
            ...
            <div className="p-5">
              ...
              <div className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-black"><Clipboard className="w-4 h-4" /> Copy prompt</div>
            </div>
          </motion.div>
          <p className="text-center text-henway-charcoal/60 mt-6 max-w-2xl mx-auto">
            Every clause traces back to a move. Nobody sat down to write a prompt. It is just your four answers, compressed.
          </p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-henway-charcoal text-white py-24">
        <div className="section-container text-center max-w-3xl">
          ...
          <p className="text-xl text-white/70 mb-4">
            The app runs the method with you: the right tool, your first prompt written for you, a one-page brief, and compliance flags. No code. No prompting skill.
          </p>
