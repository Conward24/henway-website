    ...
    <main className="pt-20">
      ...
      <section className="bg-henway-offwhite">
        <div className="section-container max-w-3xl">
          <h2 className="mb-3">A straight answer on compliance</h2>
          ...
          <p className="text-sm text-gray-500 mt-8">
            See also our{' '}
            <a href="https://app.henwayai.com/privacy" className="font-bold text-gray-600 underline">Privacy Policy</a>{' '}
            and{' '}
